...
app.get("/", function (req,res) {
  ...
  //find all articles from DB and render
...
app.post("/compose", function(req, res) {
  ...
  //creates new post and saves in DB
  const post = new Post ({
    title: postTitle,
    body: postBody
  });
...
app.get("/post/:postName", function (req, res) {
  ...
  //finds post by title when clicking 'read more' or entering title in URL
